...
const handler = async (_0x6e8a7e, {
    ...
    const _0x4d8156 = (_0x44f6bb(0x12) + _0x59bf41 + _0x44f6bb(0x36) + (_0x74a8bf[_0x44f6bb(0x1f)] - _0x480f13[_0x44f6bb(0x1f)]) + _0x44f6bb(0x25) + _0x480f13['length'] + _0x44f6bb(0x0) + _0x74a8bf[_0x44f6bb(0x1f)] + _0x44f6bb(0x8) + _0x5dd37c + _0x44f6bb(0x15) + _0xed4701 + ' رقم*\x0a╠➥ [☑️] الصحين: ' + (_0x469be0 ? _0x44f6bb(0x1e) : _0x44f6bb(0x9)) + _0x44f6bb(0x24) + (_0x287bc4 ? _0x44f6bb(0x1e) : _0x44f6bb(0x9)) + _0x44f6bb(0x2d) + (_0x5e5595 ? '*مفعل*' : '*غير مفعل*') + _0x44f6bb(0x34) + (_0x11c2ac ? _0x44f6bb(0x1e) : _0x44f6bb(0x9)) + '\x0a╠➥ [🌎] مود: ' + (_0x8e3052 ? _0x44f6bb(0x39) : _0x44f6bb(0x23)) + _0x44f6bb(0x3) + (_0x4c926e ? _0x44f6bb(0x1e) : _0x44f6bb(0x9)) + '\x0a╠➥ [🤖] البوتات الفرعيه: ' + (_0x2971a4 ? '*مفعل*' : _0x44f6bb(0x9)) + _0x44f6bb(0x18) + (_0x5d89ec ? _0x44f6bb(0x1e) : _0x44f6bb(0x9)) + _0x44f6bb(0x14) + _0xf05c38 + _0x44f6bb(0x30))[_0x44f6bb(0x33)]();
...
handler[_0x4f3522(0x2c)] = /^(ping|المعلومات|معلومات)$/i;

function _0xd63f() {
    const _0x13198c = ['vnd.openxmlformats-officedocument.presentationml.presentation', 'vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'application/', '\x0a╠═〘 _معلومات البوت_ 〙 ═\x0a╠\x0a╠➥ [🤴🏻] المصمم: *𝑨𝑵𝑮𝑬𝑳𝑶*\x0a╠➥ [#️⃣] الارقام: *+201128698632* او *+201069799352*\x0a╠➥ [🎳] البادئه;: *', 'floor', '\x0a╠➥ [👨‍🦯] السرعه: \x0a╠  *', '*\x0a╠➥ [🎩] المستخدمين: *', 'pdf', 'user', '\x0a╠➥ [📵] مضاد المكالمات: ', 'toString', '250011WlPnkk', 'entries', 'memoryUsage', 'chat', '*مفعل*', 'length', 'https://chat.whatsapp.com/HzfsFIfYTj7HdjbekZPfIT', '1403015HVUDKR', 'isChats', '*عام*', '\x0a╠➥ [❗] التقيد: ', '*\x0a╠➥ [🦜] الجروبات: *', 'info', '539328kiyuoI', 'ᴇʟ ᴍᴇᴊᴏʀ ʙᴏᴛ ᴅᴇ ᴡʜᴀᴛsᴀᴘᴘ', 'data', 'users', 'zip', 'command', ' \x0a╠➥ [💬] خاص فقط: ', '36696ziHOau', 'vnd.openxmlformats-officedocument.wordprocessingml.document', ' ms* \x0a╠\x0a╠═〘 𝑨𝑵𝑮𝑬𝑳𝑶 〙 ═\x0a', 'settings', '@g.us', 'trim', '\x0a╠➥ [🏢] جروبات فقط: ', 'help', '*\x0a╠➥ [🔐] شات الخاص: *', 'sendMessage', '3466281EgUznn', '*خاص*', 'map', '* \x0a╠➥ [💡] عدد المحادثات: *', 'tags', 'filter', '\x0a╠➥ [💬] مضاد الخاص: ', 'now', 'endsWith', '159788KEWCNi', '689064HQaqIv', '* \x0a╠➥ [🚀] النشاط: *', '*غير مفعل*', 'random', 'jid', 'join', '「  𝑯𝒆𝒍𝒍𝒐 𝑾𝒐𝒓𝒍𝒅 」', 'padStart'];
    _0xd63f = function () {
        return _0x13198c;
    };
    return _0xd63f();
