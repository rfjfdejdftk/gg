...
let handler = async (m, { conn, text }) => {
  ...
  await conn.reply(m.chat, '*انتضر جار تحميل الافتار*', fkontak, { contextInfo: { forwardingScore: 2022, isForwarded: true, externalAdReply: { title: '𝐇𝐔 𝐓𝐀𝐎-𝐵𝛩𝑇', body: `【𝟐𝟎𝟎𝟓/𝟐/𝟏𝟎】١⁵`, sourceUrl: 'https://example.com', thumbnail: '' } } });
